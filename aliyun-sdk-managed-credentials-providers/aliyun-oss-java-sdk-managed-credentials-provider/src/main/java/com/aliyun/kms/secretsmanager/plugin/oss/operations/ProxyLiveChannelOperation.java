...
public class ProxyLiveChannelOperation extends LiveChannelOperation implements ProxyOSSOperation {
    private final String secretName;
    private final AKExpireHandler akExpireHandler;

    public ProxyLiveChannelOperation(ServiceClient client, OSSClient ossClient, String secretName, AKExpireHandler akExpireHandler) {
